...
def handle_all_messages(message):
    ...
    defaults = [
        f'Хм, не понял, но рад тебя видеть! Жми 📜 Помощь или выбирай игру 🎮',
        f'Пиши /help чтобы узнать всё о боте!',
        f'Может ты ищешь джекпот? Иди в 🎰 Слоты!',
        f'Загадочно... Но лучше сыграй в 🃏 Блэкджек!',
    ]
